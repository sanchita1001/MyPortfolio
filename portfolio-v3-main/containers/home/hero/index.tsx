    ...
    <React.Fragment>
     <div id="hero" className="max-w-[1000px] mx-auto w-full relative mt-0 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-5 grid-rows-3 gap-0 sm:gap-0 md:gap-5 lg:gap-5 grid-flow-row">
        <motion.div
          ...
          className="group border border-grey-200 dark:border-[#27272a] col-span-1 lg:col-span-2 bg-cream rounded-2xl p-4 md:p-5 flex flex-col gap-6 row-span-1 lg:row-span-3 cursor-pointer dark:bg-darkBg relative overflow-hidden"
        >
          ...
          <div className="absolute inset-[1px] bg-cream dark:bg-darkBg rounded-[calc(1.5rem-1px)] z-[1] group-hover:inset-[2px] transition-all" />
        ...
        <motion.div
          ...
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="col-span-1 lg:col-span-3 border border-grey-200 dark:border-[#27272a] bg-cream rounded-3xl p-4 md:p-6 flex flex-col row-span-1 lg:row-span-2 mt-3 sm:mt-5 md:mt-0 lg:mt-0 dark:bg-darkBg relative overflow-hidden group"
        >
          <div className="absolute inset-[-2px] rounded-[inherit] z-0 overflow-hidden pointer-events-none">
            <motion.div
              animate={{
...
>
                  ...
                  <div className="flex gap-3">
                    <a
                      ...
                      target="_blank"
                      className="p-3 bg-cream dark:bg-white/10 rounded-2xl shadow-lg hover:scale-110 transition-transform flex items-center justify-center"
                    >
        ...
        <motion.div
          ...
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="flex md:flex bg-cream dark:bg-darkBg relative group cursor-pointer col-span-1 lg:col-span-3 rounded-3xl p-0 flex-col row-span-1 mt-3 sm:mt-3 md:mt-0 lg:mt-0 h-[220px] md:h-[250px] lg:h-auto overflow-hidden"
        >
          <div className="absolute inset-[-2px] rounded-[inherit] z-0 overflow-hidden pointer-events-none">
            <motion.div
              animate={{
