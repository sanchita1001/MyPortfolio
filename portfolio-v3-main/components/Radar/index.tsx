  ...
  return (
    ...
    >
      <div
        ...
        overflow-hidden animate-radar-spin w-[400px]  items-end justify-center bg-gradient-to-r from-blue-500/0 via-blue-500/20 to-blue-500/40 dark:from-blue-400/0 dark:via-blue-400/20 dark:to-blue-400/40"
      >
